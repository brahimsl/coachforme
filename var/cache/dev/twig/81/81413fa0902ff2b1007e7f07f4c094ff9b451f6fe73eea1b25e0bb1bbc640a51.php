...
class __TwigTemplate_9ba3d2f8fa9d5cdf04215f154e4b7d8e6117be12008fa4da3c91b6c800584807 extends Template
{
    ...
    <input type=\"email\" value=\"";
        ...
        echo "\" name=\"email\" id=\"inputEmail\" class=\"form-control\" placeholder=\"Votre adresse e-mail\" required autofocus>
...
{% block title %}Se connecter - Colisée!{% endblock %}
...
<form method=\"post\">
    ...
    <h1 class=\"h3 mb-3 font-weight-normal\">Merci de vous connecter</h1>
    <label for=\"inputEmail\">Email</label>
    <input type=\"email\" value=\"{{ last_username }}\" name=\"email\" id=\"inputEmail\" class=\"form-control\" placeholder=\"Votre adresse e-mail\" required autofocus>
    <label for=\"inputPassword\">Mot de passe</label>
    <input type=\"password\" name=\"password\" id=\"inputPassword\" class=\"form-control\" placeholder=\"Votre mot de passe\" required>
...
{% endblock %}
", "security/login.html.twig", "C:\\Users\\Aladine\\OneDrive\\Bureau\\udemy\\projet1\\coliseetest\\templates\\security\\login.html.twig");
    }
}
